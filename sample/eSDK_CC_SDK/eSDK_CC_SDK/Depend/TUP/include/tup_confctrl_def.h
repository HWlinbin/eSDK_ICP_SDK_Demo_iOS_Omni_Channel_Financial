...
typedef enum tagCONFCTRL_E_EVENT
{
    ...
    CONFCTRL_E_EVT_GET_CONF_LIST_RESULT,             /**< [en]Indicates get conference list result
                                                          <br>[cn]获取会议列表结果
                                                          <br>param1：TUP_UINT32 result  [en]operate result [cn]操作结果
                                                          <br>param2：None
    ...
    CONFCTRL_E_EVT_REQUEST_CONF_RIGHT_RESULT,       /**< [en]Indicates request right of conference result
                                                         ...
                                                         <br>data： CONFCTRL_S_REQ_CONFCTRL_RIGHT_RESULT* result [en]Indicates the result of confctrl right info.[cn]会控权限信息 */
...
typedef enum tagCC_OPERATION_RSP_REASON_E
{
    ...
    CC_OPERATION_SERVER_IS_PROCEEDING,  /**< [en]Indicates server is proceeding,please wait
                                             <br>[cn]正在处理中，请等待 */
    CC_OPERATION_MANAGER_EXIST,         /**< [en]Indicates the conf is controled by manager
                                             <br>[cn]会议管理员正管理会议 */
...
typedef struct tagCONFCTRL_S_CREATE_CONF_INFO
{
    ...
    TUP_UINT32 share_line_id;                           /**< [en]Indicates optional, share line id.[cn]可选，共享线路id */
...
{
    TUP_UINT32 total_count;                     /**< [en]Indicates the total number of conferences. [cn]会议总个数 */
