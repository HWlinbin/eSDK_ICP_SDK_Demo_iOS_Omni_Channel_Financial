...
enum
{
    ...
    COMPT_MSG_ANNO_CREATE_NEWID        = 2901,       /**< [en]Indicates to create an ANNO 
                                                          <br>[cn]新建一个标注  
                                                          <br>param1: TUP_UNIT32 seq_number [en]Indicates the serial number. [cn]序列号.
                                                          <br>param2: TUP_UNIT32 new_id [en]Indicates the id. [cn]标注ID.
                                                          <br>data:   None */     
    ...
    COMPT_MSG_ANNO_HITTEST2            = 2905,       /**< [en]Indicates whether a point is dropped on the label.
                                                          ...
                                                          <br>param1: None
                                                          <br>param2: None
                                                          <br>data:   TUP_UNIT32* ids [en]Result. [cn]结果. */         
